        ...
        <section className="_section relative">
            ...
            <div className="_wrapper flex flex-col justify-between overflow-hidden font-extrabold text-black">
                ...
                <div className="grid grid-rows-1 grid-cols-2 w-full gap-x-5 text-white">
                    <div className="flex flex-col col-span-1 row-span-1 p-[40px] bg-_gray rounded-[45px] relative bg-[url('/img/components/02about/eclipse2.png')] bg-no-repeat bg-right-top bg-contain">
                        <Image src={icon_1}/>
                ...
                <div className="relative flex flex-col mt-[60px] px-10 pt-10 rounded-[45px] bg-gradient-to-tl to-[#FF5924] from-[#FF932F]  bg-cover bg-no-repeat">

...
import giraffix_mobile from '../../public/img/components/02About/giraffix_mobile.png'
import lines from '../../public/img/components/02About/lines.png'
import lines_left from '../../public/img/components/02About/lines-left.png'
import lines_right from '../../public/img/components/02About/lines-right.png'
...
export default function About(){
    return (
        <section className="_section relative">
            ...
            <div className="hidden md:block w-full scale-x-[-1] h-[120%] absolute -bottom-1/3 -z-40 bg-contain bg-no-repeat bg-[url('/img/components/eclipse.png')]"></div>
            ...
            <div className="_wrapper flex flex-col justify-between overflow-hidden font-extrabold text-black pb-2">
                ...
                <div className="grid grid-rows-1 grid-cols-2 w-full gap-5 text-white">
                    <div className="flex flex-col col-span-2 sm:col-span-1 row-span-1 p-[40px] bg-_gray rounded-[45px] relative bg-[url('/img/components/02about/eclipse2.png')] bg-no-repeat bg-right-top bg-contain">
                        <Image src={icon_2}/>
                ...
                <div className="relative overflow-hidden  flex flex-col mt-[35px] md:mt-[60px] md:px-10 pt-6 md:pt-10 rounded-[45px] bg-gradient-to-tl to-[#FF5924] from-[#FF932F]  bg-cover bg-no-repeat _shadow">
                    ...
                    <Image className='relative z-50 hidden xs:block mx-auto w-1/3 md:w-1/6 pt-10' src={giraffix_desktop}/>
                    <Image className='relative z-50 block xs:hidden mx-auto w-1/2 pt-10' src={giraffix_mobile}/>
                    <Image className='absolute -left-[35%] md:left-0 bottom-[4%] md:bottom-[5%] w-2/3 md:w-1/4' src={lines_left}/>
                    <Image className='absolute w-2/3 right-[-40%] md:right-0 bottom-[0%] md:w-1/4  md:top-[5%]' src={lines_right}/>
                </div>
            </div>
        </section>
    )

...
export default function About(){
    return (
        <section className="_section relative">
            ...
            <div className="_animate-mission hidden md:block w-full scale-x-[-1] h-[120%] absolute -bottom-1/2 -z-40 bg-contain bg-no-repeat bg-[url('/img/components/eclipse.png')]"></div>
            ...
            <div className="_wrapper flex flex-col justify-between overflow-hidden font-extrabold text-black pb-2">
                ...
                <div data-aos="fade-up" data-aos-duration="1500" className="relative overflow-hidden  flex flex-col mt-[35px] md:mt-[60px] md:px-10 pt-6 md:pt-10 rounded-[45px] bg-gradient-to-tl to-[#FF5924] from-[#FF932F]  bg-cover bg-no-repeat _shadow">
                    ...
                    <Image  data-aos-delay="1500" data-aos="fade-up" data-aos-duration="1500" className='relative z-50 hidden xs:block mx-auto w-1/3 md:w-1/6 pt-10' src={giraffix_desktop}/>
                    <Image  data-aos-delay="1500" data-aos="fade-up" data-aos-duration="1500" className='relative z-50 block xs:hidden mx-auto w-1/2 pt-10' src={giraffix_mobile}/>
                    <Image  data-aos-delay="1500" data-aos-duration="1500" data-aos="fade-right" className='absolute -left-[35%] md:left-0 bottom-[4%] md:bottom-[5%] w-2/3 md:w-1/4' src={lines_left}/>
                    <Image  data-aos-delay="1500" data-aos-duration="1500" data-aos="fade-left" className='absolute w-2/3 right-[-40%] md:right-0 bottom-[0%] md:w-1/4  md:top-[5%] ' src={lines_right}/>
                </div>
            </div>
        </section>
    )
